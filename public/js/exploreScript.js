...
exploreSearchButton.addEventListener('click', (e) => {
    ...
    .then((res) => {
        ...
        res.forEach((resultObj) => {
            ...
            let localComponentString = `<div class="expl-tweet-result-component">
            <div class="expl-tweet-result-image-col">
                <img class="expl-twitterlogo" src="../twitterlogo.png"/>
            </div>
            <div class="expl-tweet-result-detail-col">
                <div class="expl-tweet-result-header-container">
                    <div>
                        <span className="expl-tweet-result-header-container-text">${resultObj.user_display_name}</span>
                    </div>
                    <div>
                        <svg
                        width="1.5rem"
                    ...
                    <div>
                        <span>${resultObj.user_user_name}</span>
                    </div>
                </div>
                <div class="expl-tweet-result-description-container">
                    <span>${resultObj.text}</span>
                </div>
                <div class="expl-tweet-result-buttons-container">
                    <div class="expl-reply-button-container">
                        ...
                        <span class="expl-numspan">${resultObj.tweet_reply_length}</span>
                    </div>
                    <div class="expl-retweet-button-container">
                        <svg viewBox="0 0 24 24"
                        aria-hidden="true" 
                        width="1.7rem"
                        height="1.7rem"
                        ...
                        <span class="expl-numspan">${resultObj.tweet_retweet_length}</span>
                    </div>
                    <div class="expl-like-button-container">
                        <svg viewBox="0 0 24 24" 
                        width="1.7rem"
                        height="1.7rem"
                        aria-hidden="true">
                        ...
                        <span class="expl-numspan">${resultObj.tweet_likes_length}</span>
                    </div>
                </div>
            </div>
        </div>`;

        searchResultHtmlList += localComponentString;

        });

        searchResultListContainer.innerHTML = searchResultHtmlList;
